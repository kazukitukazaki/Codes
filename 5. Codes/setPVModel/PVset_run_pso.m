...
psoparams=[shw epoch particlesize ac(1) ac(2) Iwt(1) Iwt(2) wt_end errgrad errgraditer NaN modl PSOseed];
% tic;
% run pso
% vectorized version
[pso_out,tr,te]=PVset_pso_Trelea_vectorized(functname, dims,mv, varrange,ismaximize,psoparams,plotfcn,PSOseedValue);
% toc;
% %-------------------------------------------------------------------------- 
